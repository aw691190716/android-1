...
if args.topic:
    for argument in args.topic:
        ...
        if 'LAOS' in gerrit:
            ...
            url = 'https://android-review.googlesource.com/changes/?q=topic:%s' % tag
...
if args.query:
    for argument in args.query:
        ...
        if 'LAOS' in gerrit:
            ...
            url = 'https://android-review.googlesource.com/changes/?q=%s' % pquery
...
for argument in args.change_number:
    ...
    if 'LAOS' in gerrit:
        ...
        url = 'https://android-review.googlesource.com/changes/?q={change}&o={query_revision}&o=CURRENT_COMMIT&pp=0'.format(change=change, query_revision=query_revision)
